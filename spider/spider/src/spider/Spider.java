...
public class Spider {
	public static void main(String[] args) throws IOException {
		...
		if (b) {
			...
			String html = "";
			Response body = Jsoup.connect(url).userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.64 Safari/537.31").header("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8").header("Accept-Language", "zh-cn")
					.header("Accept","text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8")
					.header("Host","www.douban.com")
					.header("Connection","keep-alive")
					.header("Accept-Language","en-us,zh-cn;q=0.8,zh;q=0.5,en;q=0.3")
					.header("Accept-Encoding","gzip, deflate")
					.header("Cookie","bid=\"NmOUYwtrguc\"; viewed=\"2299730_4817792_1402410_4753298_25709562_4141733_1761909_1402576\"; __utma=30149280.871955665.1378794346.1396488248.1396493179.40; __utmz=30149280.1396415046.37.5.utmcsr=douban.com|utmccn=(referral)|utmcmd=referral|utmcct=/; ll=\"108288\"; __utmv=30149280.429; __utmc=30149280; dbcl2=\"4293463:kAydnRA4Mps\"; ck=\"NMsQ\"; push_noty_num=0; push_doumail_num=0; __utmb=30149280.20.10.1396493179; ct=y, value")
			.execute();
			
			for(Map.Entry en :body.cookies().entrySet()){
				System.out.println(en.getKey()+":"+en.getValue());
				
			}
			System.out.println("-------------------------------------");
			for(Map.Entry en :body.headers().entrySet()){
				System.out.println(en.getKey()+":"+en.getValue());
